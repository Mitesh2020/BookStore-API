# Installing Dependencies ( type in console ) : in <a href="https://github.com/Mitesh2020/Bookstore-API/blob/main/go.sum">go.sum</a> file you will find all installed dependencies like `package.json`.
